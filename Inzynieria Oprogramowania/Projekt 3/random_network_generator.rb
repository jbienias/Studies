...
# weights1 = File.read("D:\/Tanks\/net_tmp\/weight1.txt").gsub("\n", ",").split(",").map(&:to_f)
# bias1 = File.read("D:\/Tanks\/net_tmp\/bias1.txt").gsub("\n", ",").split(",").map(&:to_f)
# weights2 = File.read("D:\/Tanks\/net_tmp\/weight2.txt").gsub("\n", ",").split(",").map(&:to_f)
# bias2 = File.read("D:\/Tanks\/net_tmp\/bias2.txt").gsub("\n", ",").split(",").map(&:to_f)
